...
def place_field(spatial_map: SpatialSpikeTrain2D | HaftingRateMap | np.ndarray, **kwargs):
    '''
    ...
    if isinstance(spatial_map, HaftingRateMap) or isinstance(spatial_map, SpatialSpikeTrain2D):
